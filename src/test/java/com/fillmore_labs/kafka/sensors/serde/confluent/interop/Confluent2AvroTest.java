...
public final class Confluent2AvroTest {
  ...
  public Confluent2AvroTest(String description, Supplier<SingleTestComponent> componentSupplier) {
  ...
  public static List<Object[]> parameters() {
    return TestHelper.parametersWithDuration(REGISTRY_TEST_RESOURCE.registryUrl());
  }
