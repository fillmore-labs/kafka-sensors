...
/* package */ final class DurationCalculator {
  private final KeyValueStore<String, Reading> stateStore;

  /* package */ DurationCalculator(KeyValueStore<String, Reading> stateStore) {
    this.stateStore = stateStore;
  }

  public Optional<ReadingDuration> compute(String id, Reading reading) {
