...
image:https://api.codeclimate.com/v1/badges/82f37cb8b3ed9b9b845a/maintainability[title="Code Climate maintainability",link=https://codeclimate.com/github/fillmore-labs/kafka-sensors/maintainability]
