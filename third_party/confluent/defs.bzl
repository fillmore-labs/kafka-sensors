...
def confluent_repositories():
    http_archive(
        ...
        url = "https://github.com/confluentinc/common/archive/refs/tags/v7.2.1.tar.gz",
    )
    http_archive(
        ...
        url = "https://github.com/confluentinc/schema-registry/archive/refs/tags/v7.2.1.tar.gz",
    )
